...
module.exports = async (ctx, config, { strapi }) => {
  ...
  if (!AUTH0_DOMAIN) {
    strapi.log.error('is-admin-or-socio-or-verificador: falta AUTH0_DOMAIN en el .env');
    return false;
  }
  ...
  if (!email) {
    strapi.log.warn('is-admin-or-socio-or-verificador: Auth0 no devolvió email');
    return false;
  }
