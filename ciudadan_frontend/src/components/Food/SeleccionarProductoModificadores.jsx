...
const SeleccionarProductoModificadores = ({
  ...
  showAlert = true,
  indicationMessage = "Selecciona las opciones que el cliente podrá personalizar al realizar su pedido."
}) => {
  ...
  const isSelected = (modifierId) => selectedModifiers.includes(modifierId);
    ...
    <Box mt={2}>
      ...
      >
        ...
        {modifierGroups.map((group) => {
          const modifiers = group.modificadores || group.food_modifiers || [];
