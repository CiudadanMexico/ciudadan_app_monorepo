...
import { taresProv as tareasGeneralesMock } from '../../components/Cowork/mock.jsx';

const USAR_MOCK_GENERALES = true; // 👈 flag temporal para visualizar el diseño sin backend
...
const CooWork = () => {
  ...
  const fetchGeneralTodos = useCallback(async () => {
    if (USAR_MOCK_GENERALES) {
      setLoadingGeneral(false);
      setGeneralError(null);
      setGeneralTodos(tareasGeneralesMock);
      return;
    }
  ...
  const handleSaveEdit = useCallback(() => {
    ...
    console.log('✏️ Cambios guardados localmente (mock, sin persistir en backend):', editForm);
    handleCloseEditDialog();
  }, [editForm, handleCloseEditDialog]);
